...
call adt -package -storetype pkcs12 -keystore bat/Swivel.p12 -target bundle bin/Swivel application.xml bin/Swivel.swf ffmpeg/win64 ffmpeg/licenses assets/icons license.txt
